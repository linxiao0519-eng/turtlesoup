...
<style>
    ...
    [data-testid="stChatInput"] { background-color: #FFFFFF !important; border: 2px solid #38BDF8 !important; border-radius: 12px !important; }
...
st.markdown('<p class="subtitle-text">> System Status: SECURE | Protocol: v7.0 (Final)</p>', unsafe_allow_html=True)
...
if "secret_target" not in st.session_state:
    try:
        ...
        setup_prompt = "請隨機產生一個『非常難猜、冷門、或是帶有台灣懷舊色彩』的物品或遊戲作為謎底，只需輸出『名詞』本身，絕對不要有任何其他廢話或標點符號。"
